...
BUILD="! /usr/bin/env sh $SNAKEGIT_HOME/bin/build.sh"
...
UPLOAD="! /usr/bin/env sh $SNAKEGIT_HOME/bin/upload.sh"
...
TEST="! /usr/bin/env sh $SNAKEGIT_HOME/bin/test.sh"
...
LINT="! /usr/bin/env sh $SNAKEGIT_HOME/bin/lint.sh"
...
SLITHER="! /usr/bin/env sh $SNAKEGIT_HOME/bin/sdist.sh"
...
SNAKE_SHED="! /usr/bin/env sh $SNAKEGIT_HOME/bin/clean.sh"
...
SNAKE_UPDATE="! /usr/bin/env sh $SNAKEGIT_HOME/bin/selfupdate.sh"
